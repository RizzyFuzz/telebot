...
exports.clearTmp = () => {
  ...
  console.log(chalk.cyanBright("Clear/Cached File tmp!"));
};
...
//logs
exports.banner = cfonts.render("RizzyFuzz|Bot Telegram", {
  font: "chrome",
  color: "candy",
  align: "center",
  gradient: ["red", "green"],
...
const LinkGet = async (bot, file_id) => {
  try {
...
exports.weton = ["Pahing", "Pon", "Wage", "Kliwon", "Legi"][
...
• Furry Edition •
/e621search <artist/tag>

`;
global.sfwmenu = `• Anime •
/randomwaifu
/randomneko
...
`;
global.downloadermenu = `/tiktok <link>
/ytmp3 <link>
/ytmp4 <link>
/soundcloud <link>
`;
...
/gempaterkini
`;
global.adminmenu = `/pin <reply pesan>
`;
global.groupmenu = `/cekadmin
`;
/*#*#*#*#*#*#*#*#*#* END MENU ALL *#*#*#*#*#*#*#*/
...
exports.sendVideo = (rizz, url, filename, caption) => {
  rizz.replyWithVideo(
    {
      url: url,
      filename: filename,
